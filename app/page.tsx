...
const translations = {
  pt: {
    ...
    hero: {
      ...
      subtitle: "Um espaço aonde a excelência está presente em cada detalhe.",
    ...
    about: {
      ...
      description1:
        "A Barbearia Seletto foi projetada não apenas para oferecer cortes de cabelo e barbas de alta qualidade, focando também em proporcionar uma experiência personalizada para cada cliente. Nossos profissionais são especialistas em serviços masculinos, comprometidos com excelência e conforto.",
      description2:
        "O ambiente da barbearia é acolhedor e familiar, ideal para relaxar enquanto cuida da aparência. Aqui, você encontra o lugar perfeito para alcançar sua melhor versão com qualidade.",
      stats: {
        ...
        >
          ...
          >
            <Image
              ...
              width={80}
              height={80}
              className="mx-auto md:w-[100px] md:h-[100px] rounded-full"
            />
          </motion.div>
          <motion.h1
    ...
    <div className="min-h-screen bg-[#0e1728] text-white overflow-x-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            <Image
              ...
              width={100}
              height={100}
              className="mx-auto mb-6 md:mb-8 md:w-[120px] md:h-[120px] rounded-full"
            />
          </motion.div>
            ...
            >
              <div className="bg-[#0e1728] rounded-lg p-6 md:p-8 border border-[#768ca4]/20">
                ...
                <div className="aspect-video bg-gradient-to-br from-[#768ca4]/20 to-[#c8a35f]/20 rounded-lg overflow-hidden relative">
                  <Image
                    src="/experiencia-premium.jpg"
                    alt="Experiência Premium - Equipamentos profissionais"
                    width={400}
                    height={300}
              ...
              <CardContent className="p-6 md:p-8 lg:p-12">
                <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-center">
                  ...
                  <div className="relative order-first lg:order-last">
                    <div className="bg-gradient-to-br from-[#768ca4]/30 to-[#c8a35f]/30 rounded-lg p-4 md:p-6 overflow-hidden">
                      <div className="aspect-video rounded-lg overflow-hidden mb-4">
                        <Image
                          src="/barboterapia.jpg"
                          alt="Barboterapia - Relaxamento com toalha quente"
                          width={400}
                          height={300}
                          className="w-full h-full object-cover"
                        />
      ...
      <section id="gallery" className="py-12 md:py-20 bg-[#1f2937] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group"
              >
                <Card className="bg-gradient-to-br from-[#0e1728] to-[#1f2937] border-[#768ca4]/20 hover:border-[#c8a35f]/50 transition-all duration-500 text-center h-full hover:shadow-xl hover:shadow-[#c8a35f]/10 group-hover:scale-105">
                  <CardContent className="p-4 md:p-6">
                    <motion.div
          ...
          {/* Mobile Gallery - Enhanced Vertical Scroll */}
          <div className="block md:hidden">
            <div className="relative h-[600px] overflow-hidden rounded-xl">
              {/* Mobile Infinite Scroll Container */}
              <div className="absolute inset-0">
                {/* First Column - Slow Scroll */}
                  ...
                  >
                    {[
                      ...
                      .map((item, index) => (
                        ...
                        >
                          <div className="relative overflow-hidden rounded-lg bg-[#0e1728] border border-[#768ca4]/20 hover:border-[#c8a35f]/50 transition-all duration-500">
                ...
                {/* Second Column - Fast Scroll Reverse */}
              ...
              <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#1f2937] to-transparent pointer-events-none z-10"></div>
              <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#1f2937] to-transparent pointer-events-none z-10"></div>
            </div>
          </div>

          {/* Desktop Gallery - Multi-Row Infinite Scroll */}
                ...
                >
                  {[
                    ...
                    .map((item, index) => (
                      <motion.div
                        key={`row1-${index}`}
                        className={`${item.size} flex-shrink-0 group cursor-pointer`}
                        whileHover={{ scale: 1.05, zIndex: 10 }}
                        transition={{ type: "spring", stiffness: 300 }}
                      >
                        <div className="relative overflow-hidden rounded-xl bg-[#0e1728] border border-[#768ca4]/20 hover:border-[#c8a35f]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#c8a35f]/20 h-full">
              ...
              >
                <Link href="https://www.instagram.com/barbeariaseletto/" target="_blank">
                  <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                  />
                  <Instagram className="w-4 h-4 md:w-5 md:h-5 mr-2 relative z-10" />
                  <span className="relative z-10">{t.gallery.seeMore}</span>
                </Link>
              </Button>
            </motion.div>
          </motion.div>
